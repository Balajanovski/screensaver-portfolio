...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.5\linewidth]{MandelbrotAxis}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.5\linewidth]{SmoothMandelbrot}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.5\linewidth]{Raytracing}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.5\linewidth]{Spheretracing}
...
\begin{minipage}{.3\textwidth}
  \centering
  \includegraphics[width=.9\linewidth]{fbm}
\end{minipage}%
\begin{minipage}{.3\textwidth}
  \centering
  \includegraphics[width=.9\linewidth]{worley}
\end{minipage}%
\begin{minipage}{.3\textwidth}
  \centering
  \includegraphics[width=.9\linewidth]{perlin-worley}
\end{minipage}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=.8\linewidth]{height-functions}
